<%@ Page Title="" Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="MasterPage.aspx.cs" Inherits="GPELibrary.WebForm" %>
    ...
    <form id="form1" runat="server">
        ...
        <footer>
            ...
            <div id="footer2" class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <p style="color:whitesmoke">&copy All Rights Reserved. <a class="footerlinks" href="#" target="_blank">K&K Company</a></p>
                    </div>
                </div>
            </div>
